...
guides, Developer Docs, and Repo Hygiene records. For the 0.8.1 release story and current
known limits, see [docs/releases/0.8.1/RELEASE_NOTES.md](docs/releases/0.8.1/RELEASE_NOTES.md).
...
[docs/releases/0.8.1/RELEASE_NOTES.md](docs/releases/0.8.1/RELEASE_NOTES.md) for the current release notes,
