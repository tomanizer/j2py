...
| External case studies provide bounded runtime evidence for java-semver and Apache Commons Codec `Hex` without claiming full-library automatic migration. | `docs/CASE_STUDY_JSEMVER.md`, `docs/CASE_STUDY_COMMONS_CODEC_HEX.md` | `tests/case_study/test_commons_codec_hex_case_study.py`; `tests/case_study/commons_codec_hex_harness.py`; `tests/fixtures/case_study/commons_codec_hex/`; `tests/fixtures/case_study/java_semver/` |
