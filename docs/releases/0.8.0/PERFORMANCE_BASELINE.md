# 0.8.0 performance baseline

This page records the 0.8.0 release performance baseline for representative local
translation and reporting paths. The numbers remain the 0.7.0 representative baseline
until a dedicated performance probe is rerun for 0.8.0; no code optimization was merged
