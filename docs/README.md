...
| Assessment | Diagnose project readiness and migration risk | `j2py doctor`, corpus reports, diagnostics | [Assessment](ASSESSMENT.md), [Doctor](DOCTOR.md), [SARIF](SARIF.md) |
