...
| [releases/0.8.1/RELEASE_NOTES.md](releases/0.8.1/RELEASE_NOTES.md) | 0.8.1 release notes, user-facing scope, quality evidence, and known limits. |
| [releases/0.8.1/CANDIDATE_EVIDENCE.md](releases/0.8.1/CANDIDATE_EVIDENCE.md) | 0.8.1 package build, clean install smoke, and pre-tag checklist evidence. |
| [releases/0.8.1/DOCUMENTATION_AUDIT.md](releases/0.8.1/DOCUMENTATION_AUDIT.md) | 0.8.1 docs audit against live CLI help, config schema, fixtures, and generated output. |
| [releases/0.8.1/TEST_EVIDENCE.md](releases/0.8.1/TEST_EVIDENCE.md) | Release-facing claim-to-evidence inventory for 0.8.1. |
| [releases/0.8.1/PERFORMANCE_BASELINE.md](releases/0.8.1/PERFORMANCE_BASELINE.md) | Local translation, Spring smoke, and corpus reporting performance baseline for 0.8.1. |
| [releases/0.8.1/DIAGNOSTICS_TODO_AUDIT.md](releases/0.8.1/DIAGNOSTICS_TODO_AUDIT.md) | Diagnostics and TODO wording audit for framework and platform boundaries. |
