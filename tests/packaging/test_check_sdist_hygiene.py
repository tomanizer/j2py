...
def test_forbidden_entries_detects_local_and_generated_state(
    ...
    entries = [
        ...
        "j2py_converter-1.0.0/.cursor/projects/state.json",
        ...
        "j2py_converter-1.0.0/.pypy_cache/module.json",
        "j2py_converter-1.0.0/venv/bin/python",
        "j2py_converter-1.0.0/htmlcov/index.html",
        "j2py_converter-1.0.0/.tox/log/tox.log",
        "j2py_converter-1.0.0/target/classes/Main.class",
        "j2py_converter-1.0.0/.gradle/config.bin",
        "j2py_converter-1.0.0/lib.so",
